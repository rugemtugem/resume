export const personalInfo = {
    ...
    github: "https://github.com/rugemtugem",
};
...
export const experiences = [
    ...
    },
    {
        ...
        responsibilities: [
            ...
            "Tecnologias: HTML, CSS, JavaScript, React, PHP, MySQL, WordPress",
...
export const projects = [
    ...
    },
    {
        ...
        description:
            "Liderança de projetos digitais do conceito à entrega. Desenvolvimento de interfaces modernas e consistentes, tradução de requisitos de negócio em soluções técnicas, e implementação de design systems com boas práticas de front-end.",
    },
    {
        ...
        description:
            "Evolução da experiência do usuário em sistemas digitais complexos. Desenvolvimento de interfaces responsivas e otimizadas com integração entre design e código funcional, focando em performance e compatibilidade cross-browser.",
    },
    {
        ...
        description:
            "Criação de plataforma digital integrada de e-commerce com execução completa do processo de UX/UI. Implementação em WordPress com foco em escalabilidade e simplificação de fluxos complexos para o usuário final.",
    },
    {
